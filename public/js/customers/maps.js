...
function initMap() {
  ...
  inputAdd = document.getElementById("loc_address");
  inputUbi = document.getElementById("loc_ubigeo");
  inputLat = document.getElementById("loc_lat");
  inputLng = document.getElementById("loc_lng");
