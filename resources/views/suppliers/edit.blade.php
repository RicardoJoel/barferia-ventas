...
<form method="POST" action="{{ route('suppliers.update',$supplier->id) }}" role="form" id="frm-supplier">
	...
	<input type="hidden" id="other_ubigeo" value="{{ old('ubigeo',$supplier->other_ubigeo) }}">
	<div class="fila">
		<div class="columna columna-1">
				...
				<div id="div-gen">
					<div class="fila">
						...
						<div class="columna columna-2">
							...
							<input type="text" name="name" id="name" maxlength="100" value="{{ old('name',$supplier->name) }}" required>
						</div>
					...
					<div class="fila">
						...
						<div class="columna columna-2">
							...
							<input type="text" name="other" id="other" maxlength="100" value="{{ old('other',$supplier->other) }}" disabled>
						</div>
					</div>
				</div>
			</div>
				...
				<div id="div-ctt">
					<div class="fila">
						<div class="columna columna-2">
							...
							<input type="text" name="address" id="address" maxlength="100" value="{{ old('address',$supplier->address) }}" required>
						</div>
						<div class="columna columna-2">
							...
							<select name="ubigeo" id="ubigeo" required>
								...
								<option value="{{ $index }}" {{ old('ubigeo',$supplier->ubigeo_id) == $index ? 'selected' : '' }}>{{ $ubigeo }}</option>
								@endforeach
							</select>
						</div>
					</div>
					<div class="fila">
						<div class="columna columna-6">
							...
							<select name="country_id" id="country_id" required>
								...
								<option value="{{ $index }}" {{ old('country_id',$supplier->country_id) == $index ? 'selected' : '' }}>{{ $country }}</option>
								@endforeach
							</select>
						</div>
						<div class="columna columna-6">
