                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form action="{{ action('SupplierController@destroy', $supplier->id) }}" method="post">
                            ...
                            <button class="btn btn-danger btn-xs" type="submit" onclick="return confirm('¿Realmente deseas eliminar el proveedor seleccionado?')"><span class="glyphicon glyphicon-trash"></span></button>
                        </form>
                        </center>
                    </td>
                </tr>
