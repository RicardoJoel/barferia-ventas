...
<div class="fila">
	<div class="columna columna-1">
		<div class="title2">
			<h6>Entidades > Locales > Nuevo ></h6>
		</div>
	</div>
</div>
<form method="POST" action="{{ route('centers.store') }}" role="form" id="frm-center">
	@csrf
			...
			<div class="form-section">
				...
				<div id="div-gen">
					<div class="fila">
						...
						<div class="columna columna-3">
							<p>Cod. Referencial*</p>
							<input type="text" name="nemo" id="nemo" maxlength="3" value="{{ old('nemo') }}" onkeypress="return checkAlNum(event)" onkeyup="return mayusculas(this)" required>
						</div>
						<div class="columna columna-3c">
							<p>Tipo*</p>
							<select name="type" id="type" required>
                                <option value="T" {{ old('type') == 'T' ? 'selected' : '' }}>Centro de distribución</option>
                                <option value="F" {{ old('type') == 'F' ? 'selected' : '' }}>Centro de producción</option>
                            </select>
						</div>
					</div>
				</div>
			...
			<div class="form-section">
				...
				<div id="div-ubi">
					<div class="fila">
						...
						<div class="columna columna-1">
							<p>Dirección*</p>
							<input type="text" name="address" id="address" value="{{ old('address') }}" maxlength="100" class="controls" placeholder="" required>
						</div>
						<div class="columna columna-1">
						...
						<div class="columna columna-1">
							...
							<input type="text" name="ref" id="ref" value="{{ old('ref') }}" maxlength="100">
						</div>
					</div>
				</div>
			</div>
