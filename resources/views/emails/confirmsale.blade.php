                ...
                <table width="100%" cellspacing="0" cellpadding="0">
                    <tbody><tr>
                        <td>
                            ...
                            <p style="color:#808080;margin: 0;font-size: 16px;">Te ha llegado este correo porque hemos recibido una solicitud de restablecimiento de contraseña para tu cuenta en <span style="color:#F09006"><b>{{ config('app.name', 'Laravel') }}</b></span>.</p>
                        </td>
                        <td>
