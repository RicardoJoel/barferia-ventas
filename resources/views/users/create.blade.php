...
<div class="fila">
	<div class="columna columna-1">
		<div class="title2">
			<h6>Entidades > Usuarios > Nuevo ></h6>
		</div>
	</div>
</div>
<form method="POST" action="{{ route('register') }}" role="form" id="frm-user">
	...
	<input type="hidden" id="contact_other_ubigeo" value="{{ old('contact_ubigeo') }}">
	<div class="fila">
        <div class="columna columna-1">
				...
				<div id="div-lab">
					<div class="fila">
						...
						<div class="columna columna-5d">
							...
							<select name="center_id" id="center_id" disabled>
								...
								<option value="{{ $index }}" {{ old('center_id') == $index ? 'selected' : '' }}>
									{{ $center }}
								</option>
								@endforeach
							</select>
					...
					<div class="fila">
						<div class="columna columna-5">
							...
							<input type="number" name="str_salary" id="str_salary" value="{{ old('str_salary') }}" min="0" onkeypress="return checkNumber(event)" required>
						</div>
						<div class="columna columna-5">
							<p>Comisión (%)</p>
							<input type="number" name="commission" id="commission" value="{{ old('commission') }}" min="0" onkeypress="return checkNumber(event)">
						</div>
						<div class="columna columna-5">
			...
			<div class="form-section">
				...
				<div id="div-mrg" style="display:none">
					<div class="fila">
						...
						<div class="columna columna-3">
							<p>Dirección</p>
							<input type="text" name="contact_address" id="contact_address" maxlength="100" value="{{ old('contact_address') }}">
						</div>
					</div>
					<div class="fila">
						<div class="columna columna-3">
							...
							<select name="contact_ubigeo" id="contact_ubigeo">
								@foreach ($ubigeos->get() as $index => $ubigeo)
								<option value="{{ $index }}" {{ old('contact_ubigeo') == $index ? 'selected' : '' }}>{{ $ubigeo }}</option>
								@endforeach
							</select>
						</div>
						<div class="columna columna-6">
							...
							<select name="contact_country_id" id="contact_country_id">
								<option selected disabled hidden value="">Selecciona un país</option>
								@foreach ($countries->get() as $index => $country)
								<option value="{{ $index }}" {{ old('contact_country_id',164) == $index ? 'selected' : '' }}>{{ $country }}</option>
								@endforeach
							</select>
						</div>
						<div class="columna columna-6">
